...
func (_m *CalculateDiff) Execute(prev dto.LineMap, curr dto.LineMap) (dto.LinesDiff, error) {
	...
	var r0 dto.LinesDiff
	var r1 error
	if rf, ok := ret.Get(0).(func(dto.LineMap, dto.LineMap) (dto.LinesDiff, error)); ok {
		return rf(prev, curr)
	}
	if rf, ok := ret.Get(0).(func(dto.LineMap, dto.LineMap) dto.LinesDiff); ok {
		r0 = rf(prev, curr)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(dto.LinesDiff)
		}
	}

	if rf, ok := ret.Get(1).(func(dto.LineMap, dto.LineMap) error); ok {
		r1 = rf(prev, curr)
	} else {
		r1 = ret.Error(1)
	}
...
func (_c *CalculateDiff_Execute_Call) Run(run func(prev dto.LineMap, curr dto.LineMap)) *CalculateDiff_Execute_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(dto.LineMap), args[1].(dto.LineMap))
	})
	return _c
}

func (_c *CalculateDiff_Execute_Call) Return(_a0 dto.LinesDiff, _a1 error) *CalculateDiff_Execute_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *CalculateDiff_Execute_Call) RunAndReturn(run func(dto.LineMap, dto.LineMap) (dto.LinesDiff, error)) *CalculateDiff_Execute_Call {
	_c.Call.Return(run)
	return _c
}

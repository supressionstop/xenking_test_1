...
func (_m *LineProvider) GetLine(ctx context.Context, sport string) (entity.Line, error) {
...
func (_c *LineProvider_GetLine_Call) Return(_a0 entity.Line, _a1 error) *LineProvider_GetLine_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *LineProvider_GetLine_Call) RunAndReturn(run func(context.Context, string) (entity.Line, error)) *LineProvider_GetLine_Call {
	_c.Call.Return(run)
	return _c
}
